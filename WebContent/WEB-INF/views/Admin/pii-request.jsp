...
<div>
<form:form name="myform" action="sendForVerification" method="post" modelAttribute="piiForm">
	 ...
	 <button class="btn btn-large btn-success" type="submit" >Send for verification</button>
    </form:form>
