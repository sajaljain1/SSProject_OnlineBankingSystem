		...
		<div class="contact-block-inner container">
			<div class="clear">
				<div class="login-block-form col-tablet-12">
					...
					<sf:form class="login-form" id="newPasswordForm" name="myform" method="post"
						action="${pageContext.request.contextPath}/new_password" commandName="OTPRequestInfo">
						<fieldset>
					...
					<br /> <a href="${pageContext.request.contextPath}/login">Sign in</a><br /> <a
						href="${pageContext.request.contextPath}/welcome">Home</a><br />
				</div>
			</div>
		</div>
	</div>
